...
void NET_Init (void)
{
	...
	if (COM_CheckParm("-listen") || cls.state == ca_dedicated)
		listening = true;
	net_numsockets = svs.clients.size();
...
void NET_Poll(void)
{
	...
	if (!configRestored)
	{
		if (serialAvailable)
		{
			...
			SetModemConfig (0, (char*)config_modem_dialtype.string.c_str(), (char*)config_modem_clear.string.c_str(), (char*)config_modem_init.string.c_str(), (char*)config_modem_hangup.string.c_str());
		}
		configRestored = true;
	}
